  ...
  "tab-basic": [
    {
      ...
      fields: [
        ...
        ["phone", "手机号"], ["email", "邮箱"],
        ["id_type", "证件类型", "select", ["内地身份证", "身份证", "护照", "港澳居民来往内地通行证", "台湾居民来往大陆通行证"]],
        ["id_card", "证件号码"], ["nationality", "国籍"],
        ["city", "现住地", "text", null, true], ["native_place", "籍贯"],
        ["huji_place", "户口所在地"], ["childhood_city", "童年时所在城市"],
        ["ethnic", "民族"], ["height", "身高(cm)"], ["weight", "体重(kg)"],
        ["religion", "宗教信仰"], ["marital", "婚否", "select", ["未婚", "已婚", "离异", "丧偶", "保密"]],
        ["political", "政治面貌", "select", ["中共党员", "中共预备党员", "共青团员", "群众", "民主党派"]],
        ["qq", "QQ"], ["wechat", "微信"], ["im", "IM联系方式"],
        ["homepage", "个人主页", "text", null, true], ["portfolio", "作品链接", "text", null, true],
        ["weibo", "微博", "text", null, true], ["zhihu", "知乎", "text", null, true],
        ["bilibili", "B站", "text", null, true], ["xiaohongshu", "小红书", "text", null, true],
        ["douban", "豆瓣", "text", null, true],
      ],
    },
  ],
  "tab-career": [
    {
      ...
      fields: [
        ...
        ["salary", "期望入职年薪/薪资"], ["salary_5y", "五年后期望年薪"],
        ["source", "招聘信息来源"],
  ...
  "tab-other": [
    {
      ...
      fields: [
        ...
        ["intern_before_grad", "毕业前能否实习", "select", ["是", "否"]],
        ["gaokao_math", "高考数学成绩"],
        ["smoke", "是否吸烟", "select", ["不吸烟，无吸烟史", "已戒烟", "吸烟"]],
        ["infectious", "有无传染病", "select", ["无", "有"]],
        ["major_illness", "有无重大病史", "select", ["无", "有"]],
        ["chronic", "有无慢性疾病", "select", ["无", "有"]],
      ],
    },
    {
      title: "游戏经历问答（游戏公司问卷）",
      prefix: "games_meta",
      fields: [
        ["total_hours", "游戏总时长", "text", null, true],
        ["total_spend", "游戏总花费", "text", null, true],
        ["console_games", "玩过的单机游戏（顿号分隔）", "textarea", null, true],
        ["online_games", "玩过的网络游戏（顿号分隔）", "textarea", null, true],
        ["mobile_games", "玩过的手机游戏（顿号分隔）", "textarea", null, true],
      ],
    },
    {
      title: "自我描述",
...
const FW_LISTS = [
  { key: "educations", title: "教育经历", hint: "请从高中/大学起填", fields: [
    ...
    ["rank", "专业排名", "select", ["前10%", "前20%", "前25%", "前50%", "其他"]],
    ["tongzhao", "是否统招", "select", ["是", "否"]],
    ["abroad", "是否海外留学", "select", ["是", "否"]],
    ["start", "开始时间", "month"], ["end", "结束时间", "month"],
  ]},
  { key: "family", title: "家庭成员", fields: [
    ["name", "姓名"], ["relation", "与自己关系", "select", ["父子", "母女", "母子", "父女", "兄弟", "姐妹"]],
    ["age", "年龄"], ["job", "职业"], ["position", "职位"], ["company", "工作单位"],
  ]},
  { key: "competitions", title: "竞赛奖项", fields: [
    ["name", "竞赛奖项"], ["level", "竞赛级别", "select", ["国际", "国家级", "省市地区级", "市级", "校级"]],
    ["prize", "奖励级别", "select", ["特等奖", "一等奖", "二等奖", "三等奖", "金奖", "银奖", "铜奖", "优胜奖", "优秀奖"]],
    ["date", "时间", "month"], ["description", "竞赛说明", "textarea"],
  ]},
  { key: "activities", title: "校园活动", fields: [
    ["org", "组织单位"], ["role", "职务"],
    ["start", "开始时间", "month"], ["end", "结束时间", "month"],
    ["description", "工作内容", "textarea"],
  ]},
  ...
  { key: "games", title: "游戏经历（精通游戏表格）", fields: [
    ["name", "游戏名称"], ["hours", "游戏时长（小时）"],
    ["level", "游戏等级"], ["rank", "游戏排名"],
    ["depth", "精通程度描述", "textarea"],
  ]},
];
